			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active">
							<i class="fa fa-table"></i> Edytuj użytkownika
						</li>
					</ol>
				</div>
			</div>
				...
				<div class="table-responsive">
					...
					<div class="col-lg-8">
						...
						<fieldset>
							...
							<?php
							echo $this->Form->input('username',array('label'=>'Nazwa użytkownika','class' => 'form-control input-lg'));
							echo $this->Form->input('password',array('label'=>'Hasło','class' => 'form-control input-lg','empty'=>true));
							...
							echo $this->Form->input('role', array(
								'options' => array('admin' => 'Admin', 'author' => 'Author'),'class' => 'form-control input-lg'
							));
							?>
						</fieldset>
						<?php echo $this->Form->end(__('Edytuj użytkownika')); ?>
