			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active">
							<i class="fa fa-table"></i> Dodaj użytkownika
						</li>
					</ol>
				</div>
			</div>
				...
				<div class="table-responsive">
					...
					<div class="col-lg-8">
						...
						<fieldset>
							...
							echo $this->Form->input('password',array('label'=>'Hasło','class' => 'form-control input-lg'));
						...
						<?php echo $this->Form->end(__('Dodaj użytkownika')); ?>
