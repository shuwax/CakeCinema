				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active">
								<i class="fa fa-table"></i> Edycja seansu
							</li>
						</ol>
					</div>
				</div>
					...
					<div class="table-responsive">
						...
						<div class="col-lg-8">
							...
							<fieldset>
								...
								echo $this->Form->date('screening_date',array('label' => 'Data seansu','class' => 'form-control input-lg'));
								?>
								<div id="rozklad">
									<div id="sala"></div>
									<div id="dzien"></div>
								...
								<?php
								echo $this->Form->time('time',array('label' => 'Godzina','class' => 'form-control input-lg'));
							...
							<?php echo $this->Form->end(__('Edytuj',array('id' => 'end'))); ?>
	...
	<script>
		...
		function wpis() {
			...
			for (var i = 0; i < tab.length; i++) {
				if (tab[i]['Screen']['screening_date'] == d.value && tab[i]['Screen']['Halls_id'] == sala && tab[i]['Screen']['id'] != editid) {
