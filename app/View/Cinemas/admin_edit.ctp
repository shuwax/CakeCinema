			...
			<div class="col-lg-12">
				<div class="table-responsive">
					...
					<div class="col-lg-8">
						...
						<fieldset>
							<legend style="text-align: center"><?php echo __('Edycja Kina'); ?></legend>
							<?php
							echo $this->Form->input('name',array('label' => 'Nazwa Kina','class' => 'form-control input-lg'));
							...
							echo $this->Form->input('phone_number',array('label' => 'Numer kontaktowy','class' => 'form-control input-lg'));
